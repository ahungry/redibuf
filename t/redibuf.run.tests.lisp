...
;;;; redibuf.run.tests.lisp

(in-package #:cl-user)

(defpackage redibuf.run.tests
  (:use :cl
        :redibuf.lib.stub
        :af.lib.ansi-colors
        :af.lib.coverage
...
(in-package #:redibuf.run.tests)

(defparameter *base-directory* (asdf:system-source-directory :redibuf))
...
(defun coverage ()
  ...
  (af.lib.coverage:with-coverage :redibuf
    (test)
    (terpri)
...
;;; "redibuf.run.tests" goes here. Hacks and glory await!
